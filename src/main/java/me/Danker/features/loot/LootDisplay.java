...
public class LootDisplay {
    ...
    public void renderPlayerInfo(RenderOverlayEvent event) {
        String display = ModConfig.autoDisplay ? AutoDisplay.display : ModConfig.getDisplay();
            ...
            switch (display) {
                ...
                case "Trophy Fishing":
                    if (!ModConfig.sessionDisplay) {
                        ...
                        if (!ModConfig.showTrophyCompletion)
                        ...
                        dropsText = EnumChatFormatting.WHITE + "Sulphur Skitter:\n" +
                                ...
                                EnumChatFormatting.DARK_PURPLE + "Karate Fish:\n" +
                                EnumChatFormatting.GOLD + "Golden Fish:";
                        if (!ModConfig.showTrophyCompletion) countText = EnumChatFormatting.WHITE + TrophyFishTracker.getTierCount(TrophyFishTracker.fishSession, "Sulphur Skitter") + "\n" +
                ...
                case "Master Mode":
                    if (!ModConfig.sessionDisplay) {
                        if (ModConfig.masterSRunsDisplay) {
