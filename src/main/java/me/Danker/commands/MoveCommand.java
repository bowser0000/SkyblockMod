	...
	public void processCommand(ICommandSender arg0, String[] arg1) throws CommandException {
		...
		switch (arg1[0].toLowerCase()) {
			case "coords":
				...
				CfgConfig.writeIntConfig("locations", "coordsX", coordsXY[0]);
				CfgConfig.writeIntConfig("locations", "coordsY", coordsXY[1]);
			...
			case "display":
				...
				CfgConfig.writeIntConfig("locations", "displayX", displayXY[0]);
				CfgConfig.writeIntConfig("locations", "displayY", displayXY[1]);
			...
			case "dungeontimer":
				...
				CfgConfig.writeIntConfig("locations", "dungeonTimerX", dungeonTimerXY[0]);
				CfgConfig.writeIntConfig("locations", "dungeonTimerY", dungeonTimerXY[1]);
			...
			case "skill50":
				...
				CfgConfig.writeIntConfig("locations", "skill50X", skill50XY[0]);
				CfgConfig.writeIntConfig("locations", "skill50Y", skill50XY[1]);
			...
			case "lividhp":
				...
				CfgConfig.writeIntConfig("locations", "lividHpX", lividHpXY[0]);
				CfgConfig.writeIntConfig("locations", "lividHpY", lividHpXY[1]);
			...
			case "caketimer":
				...
				CfgConfig.writeIntConfig("locations", "cakeTimerX", cakeTimerXY[0]);
				CfgConfig.writeIntConfig("locations", "cakeTimerY", cakeTimerXY[1]);
			...
			case "skilltracker":
				...
				CfgConfig.writeIntConfig("locations", "skillTrackerX", skillTrackerXY[0]);
				CfgConfig.writeIntConfig("locations", "skillTrackerY", skillTrackerXY[1]);
			...
			case "wateranswer":
				...
				CfgConfig.writeIntConfig("locations", "waterAnswerX", waterAnswerXY[0]);
				CfgConfig.writeIntConfig("locations", "waterAnswerY", waterAnswerXY[1]);
			...
			case "bonzotimer":
				...
				CfgConfig.writeIntConfig("locations", "bonzoTimerX", bonzoTimerXY[0]);
				CfgConfig.writeIntConfig("locations", "bonzoTimerX", bonzoTimerXY[1]);
			...
			case "golemtimer":
				...
				CfgConfig.writeIntConfig("locations", "golemTimerX", golemTimerXY[0]);
				CfgConfig.writeIntConfig("locations", "golemTimerY", golemTimerXY[1]);
			...
			case "teammatesinradius":
				...
				CfgConfig.writeIntConfig("locations", "teammatesInRadiusX", teammatesInRadiusXY[0]);
				CfgConfig.writeIntConfig("locations", "teammatesInRadiusY", teammatesInRadiusXY[1]);
			...
			case "gianthp":
				...
				CfgConfig.writeIntConfig("locations", "giantHPX", giantHPXY[0]);
				CfgConfig.writeIntConfig("locations", "giantHPY", giantHPXY[1]);
			...
			case "abilitycooldowns":
				...
				CfgConfig.writeIntConfig("locations", "abilityCooldownsX", abilityCooldownsXY[0]);
				CfgConfig.writeIntConfig("locations", "abilityCooldownsY", abilityCooldownsXY[1]);
			...
			case "dungeonscore":
				...
				CfgConfig.writeIntConfig("locations", "dungeonScoreX", dungeonScoreXY[0]);
				CfgConfig.writeIntConfig("locations", "dungeonScoreY", dungeonScoreXY[1]);
			...
			case "firepillar":
				...
				CfgConfig.writeIntConfig("locations", "firePillarX", firePillarXY[0]);
				CfgConfig.writeIntConfig("locations", "firePillarY", firePillarXY[1]);
			...
			case "minibosstimer":
				...
				CfgConfig.writeIntConfig("locations", "minibossTimerX", minibossTimerXY[0]);
				CfgConfig.writeIntConfig("locations", "minibossTimerY", minibossTimerXY[1]);
			...
			case "powdertracker":
				...
				CfgConfig.writeIntConfig("locations", "powderTrackerX", powderTrackerXY[0]);
				CfgConfig.writeIntConfig("locations", "powderTrackerY", powderTrackerXY[1]);
