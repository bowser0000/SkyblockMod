...
public class ArmourCommand extends CommandBase {
	...
	public void processCommand(ICommandSender arg0, String[] arg1) throws CommandException {
		...
		new Thread(() -> {
			...
			player.addChatMessage(new ChatComponentText(ModConfig.getColour(ModConfig.mainColour) + "Checking armor of " + ModConfig.getColour(ModConfig.secondaryColour) + username));
