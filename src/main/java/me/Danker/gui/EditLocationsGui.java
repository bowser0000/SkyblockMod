...
public class EditLocationsGui extends GuiScreen {
	...
	public void mouseReleased(int mouseX, int mouseY, int state) {
		...
		moving = null;
		CfgConfig.writeIntConfig("locations", "coordsX", MoveCommand.coordsXY[0]);
		CfgConfig.writeIntConfig("locations", "coordsY", MoveCommand.coordsXY[1]);
		CfgConfig.writeIntConfig("locations", "displayX", MoveCommand.displayXY[0]);
		CfgConfig.writeIntConfig("locations", "displayY", MoveCommand.displayXY[1]);
		CfgConfig.writeIntConfig("locations", "dungeonTimerX", MoveCommand.dungeonTimerXY[0]);
		CfgConfig.writeIntConfig("locations", "dungeonTimerY", MoveCommand.dungeonTimerXY[1]);
		CfgConfig.writeIntConfig("locations", "skill50X", MoveCommand.skill50XY[0]);
		CfgConfig.writeIntConfig("locations", "skill50Y", MoveCommand.skill50XY[1]);
		CfgConfig.writeIntConfig("locations", "lividHpX", MoveCommand.lividHpXY[0]);
		CfgConfig.writeIntConfig("locations", "lividHpY", MoveCommand.lividHpXY[1]);
		CfgConfig.writeIntConfig("locations", "cakeTimerX", MoveCommand.cakeTimerXY[0]);
		CfgConfig.writeIntConfig("locations", "cakeTimerY", MoveCommand.cakeTimerXY[1]);
		CfgConfig.writeIntConfig("locations", "skillTrackerX", MoveCommand.skillTrackerXY[0]);
		CfgConfig.writeIntConfig("locations", "skillTrackerY", MoveCommand.skillTrackerXY[1]);
		CfgConfig.writeIntConfig("locations", "waterAnswerX", MoveCommand.waterAnswerXY[0]);
		CfgConfig.writeIntConfig("locations", "waterAnswerY", MoveCommand.waterAnswerXY[1]);
		CfgConfig.writeIntConfig("locations", "bonzoTimerX", MoveCommand.bonzoTimerXY[0]);
		CfgConfig.writeIntConfig("locations", "bonzoTimerY", MoveCommand.bonzoTimerXY[1]);
		CfgConfig.writeIntConfig("locations", "golemTimerX", MoveCommand.golemTimerXY[0]);
		CfgConfig.writeIntConfig("locations", "golemTimerY", MoveCommand.golemTimerXY[1]);
		CfgConfig.writeIntConfig("locations", "teammatesInRadiusX", MoveCommand.teammatesInRadiusXY[0]);
		CfgConfig.writeIntConfig("locations", "teammatesInRadiusY", MoveCommand.teammatesInRadiusXY[1]);
		CfgConfig.writeIntConfig("locations", "giantHPX", MoveCommand.giantHPXY[0]);
		CfgConfig.writeIntConfig("locations", "giantHPY", MoveCommand.giantHPXY[1]);
		CfgConfig.writeIntConfig("locations", "abilityCooldownsX", MoveCommand.abilityCooldownsXY[0]);
		CfgConfig.writeIntConfig("locations", "abilityCooldownsY", MoveCommand.abilityCooldownsXY[1]);
		CfgConfig.writeIntConfig("locations", "dungeonScoreX", MoveCommand.dungeonScoreXY[0]);
		CfgConfig.writeIntConfig("locations", "dungeonScoreY", MoveCommand.dungeonScoreXY[1]);
		CfgConfig.writeIntConfig("locations", "firePillarX", MoveCommand.firePillarXY[0]);
		CfgConfig.writeIntConfig("locations", "firePillarY", MoveCommand.firePillarXY[1]);
		CfgConfig.writeIntConfig("locations", "minibossTimerX", MoveCommand.minibossTimerXY[0]);
		CfgConfig.writeIntConfig("locations", "minibossTimerY", MoveCommand.minibossTimerXY[1]);
		CfgConfig.writeIntConfig("locations", "powderTrackerX", MoveCommand.powderTrackerXY[0]);
		CfgConfig.writeIntConfig("locations", "powderTrackerY", MoveCommand.powderTrackerXY[1]);
	}
